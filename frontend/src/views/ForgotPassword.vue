<template>
  <div class="min-h-screen flex items-center justify-center bg-background text-foreground transition-colors duration-300 relative overflow-hidden p-4">
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute top-1/3 -left-24 w-96 h-96 bg-primary/10 rounded-full blur-[120px] animate-pulse"></div>
    ...
    <div class="glass-card w-full max-w-md p-8 sm:p-10 relative z-10 animate-in fade-in zoom-in duration-500">
      <div class="text-center mb-8">
        ...
        <p class="text-foreground/40 text-sm font-medium">通过手机号和邮箱验证重置密码</p>
      </div>
      ...
      <form @submit.prevent="handleReset" class="space-y-5">
        ...
        <div class="space-y-1.5">
          <label class="text-[10px] font-black text-foreground/30 uppercase tracking-widest ml-1">New Password</label>
        ...
        <div class="text-center pt-2">
          <span class="text-xs font-bold text-foreground/20 uppercase tracking-widest">Remembered?</span>
