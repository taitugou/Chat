  ...
  <div class="min-h-screen flex items-center justify-center bg-ios-systemGray6 text-ios-label-primary transition-colors duration-300 relative overflow-hidden p-4">
    ...
    <div class="ios-card w-full max-w-lg p-8 sm:p-10 relative z-10 animate-in fade-in zoom-in duration-500">
      <div class="text-center mb-8">
        ...
        <p class="text-ios-label-tertiary text-sm font-medium">完善信息后即可转为正式账号，防止数据丢失</p>
      </div>
      ...
      <form @submit.prevent="handleUpgrade" class="space-y-5">
        ...
        <div class="text-center pt-2">
          <button 
            type="button" 
            @click="router.back()" 
            class="text-xs font-bold text-ios-label-tertiary hover:text-ios-label-secondary transition-colors uppercase tracking-widest"
          >
            返回上一页
          </button>
        </div>
